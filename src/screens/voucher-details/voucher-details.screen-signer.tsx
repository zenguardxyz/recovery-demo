...
//     const service = new SafeService(NetworkUtil.getNetworkById(chainId)?.safeService!)
//     const safeSigner = await SafeEthersSigner.create(safeSdk, service, new ethers.providers.Web3Provider(accountDetails.provider as ethers.providers.ExternalProvider))
...
//     const NFTInstance = new Contract(nftContract, sampleNFT.abi, safeSigner)
    

//     const tran = await NFTInstance.mint()
